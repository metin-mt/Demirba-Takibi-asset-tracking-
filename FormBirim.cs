...
namespace DemirbasTakip
{
    public partial class FormBirim : Form
    {
        ...
        void verileri_cek()
        {
            string sqlkomutu = "SELECT * FROM birim WHERE birimadi like '%" + textBoxFiltreBirimAdi.Text + "%'";
        ...
        {
            this.birimTableAdapter.Fill(this.demirbasTakipDataSet.Birim);
            if (baglan.State == ConnectionState.Closed) baglan.Open();
            verileri_cek();
            bs.DataSource = ds.Tables["birim"];

            dataGridViewBirimler.DataSource = bs;
            ID_Birim.DataBindings.Add("Text", bs, "ID");
            textBoxBirimAdi.DataBindings.Add("Text", bs, "birimadi");
            buttonKaydet.Visible = false;
        }

        private void FormBirim_FormClosed(object sender, FormClosedEventArgs e)
        {
            baglan.Close();
            this.Close();
        ...
        private void buttonYeniKayit_Click(object sender, EventArgs e)
        {
            ...
            textBoxBirimAdi.Clear();
        }

        private void buttonKaydet_Click(object sender, EventArgs e)
        {
            if (textBoxBirimAdi.Text.Trim() != "")
            {
                OleDbCommand komut = new OleDbCommand();
                komut.Connection = baglan;
                komut.CommandText = "INSERT INTO birim (birimadi) Values ('" + textBoxBirimAdi.Text + "')";
        ...
        private void buttonGuncelle_Click(object sender, EventArgs e)
        {
            if (textBoxBirimAdi.Text.Trim() != "")
            {
                ...
                OleDbCommand komut = new OleDbCommand();
                komut.Connection = baglan;
                komut.CommandText = "UPDATE birim SET birimadi='" + textBoxBirimAdi.Text + "' WHERE ID=" + ID_Birim.Text;
                komut.ExecuteNonQuery();
        ...
        private void buttonSil_Click(object sender, EventArgs e)
        {
            ...
            if (cevap == DialogResult.Yes)
            {
                OleDbCommand komut = new OleDbCommand();
                komut.Connection = baglan;
                komut.CommandText = "DELETE FROM birim WHERE ID=" + ID_Birim.Text;
                komut.ExecuteNonQuery();
        ...
        private void textBoxFiltreBirimAdi_TextChanged(object sender, EventArgs e)
        {
            verileri_cek();
        }
